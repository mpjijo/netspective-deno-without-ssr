...
describe('real-time', () => {
  it("retrieves unsanitized HTML as DOM", async () => {
    const qc = await mod.queryableContent('https://jojozhuang.github.io/tutorial/mermaid-cheat-sheet/');
  ...
  it("retrieves sanitized HTML as DOM", async () => {
    const qsc = await mod.queryableSanitizedContent('https://jojozhuang.github.io/tutorial/mermaid-cheat-sheet/');
  ...
  it("retrieves readable content", async () => {
    const rc = await mod.readableContent('https://jojozhuang.github.io/tutorial/mermaid-cheat-sheet/');
