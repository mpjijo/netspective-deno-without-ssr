...
const collectionIdentity = 'solutions' as const;
...
export const solutionsSevicesCollection = ac.defineCollection({ schema: s.consultingSevicesSchema });
...
export default solutionsSevicesCollection;